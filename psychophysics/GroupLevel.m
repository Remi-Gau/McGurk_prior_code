...
for i=1:5
	...
	errorbar([1], nanmean(GroupStimByStim(i).results{1,2}(:,1)), nanstd(GroupStimByStim(i).results{1,2}(:,1)/(SizeMatFilesList)^.5), 'k')
	errorbar([2], nanmean(GroupStimByStim(i).results{1,2}(:,2)), nanstd(GroupStimByStim(i).results{1,2}(:,2)/(SizeMatFilesList)^.5), 'k')
