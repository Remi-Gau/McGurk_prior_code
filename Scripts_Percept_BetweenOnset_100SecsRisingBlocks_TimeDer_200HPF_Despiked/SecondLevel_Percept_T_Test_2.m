...
%%
cd(fullfile(StartFolder, 'SecondLevel', 'Analysis_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked'));
GroupAnalysisFolder = fullfile(StartFolder, 'SecondLevel', 'Analysis_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked', 'TTest2');
mkdir(GroupAnalysisFolder)

for TestInd=length(ListOfTest)
