function matlabbatch = subject_level_GLM_batch(matlabbatch, idx, analysis_dir, opt, slice_reference)
    ...
    matlabbatch{idx}.spm.stats.fmri_spec.timing.fmri_t0 = slice_reference;
    
    matlabbatch{idx}.spm.stats.fmri_spec.fact = struct('name',{},'levels',{});
    
    matlabbatch{idx}.spm.stats.fmri_spec.bases.hrf.derivs = [1,0]; % First is time derivative, Second is dispersion
