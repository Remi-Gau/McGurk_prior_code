...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_128HPF_Despiked', filesep, 'RT_Correlation');
...
cd Analysis_Percept_BetweenOnset_NoBlock_TimeDer_128HPF_Despiked;
...
for j=1:length(ListOfContrastNames)
    ...
    for i=1:length(SubjectsListTemp)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_128HPF_Despiked', filesep);
