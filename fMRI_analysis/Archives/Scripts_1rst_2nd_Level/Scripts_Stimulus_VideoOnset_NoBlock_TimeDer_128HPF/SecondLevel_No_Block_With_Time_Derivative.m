...
cd SecondLevel
if exist('No_Block_With_Time_Derivative','dir')==0
    mkdir No_Block_With_Time_Derivative;
end;
cd ..

GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'No_Block_With_Time_Derivative', filesep);
...
for j=1:length(ListOfTest)
    ...
    for i=1:length(SubjectsList)
        ...
        SubjectAnalysisFolder = strcat(A, filesep, num2str(SubjID), filesep,'Analysis_No_Block_With_Temporal_Derivative', filesep);
