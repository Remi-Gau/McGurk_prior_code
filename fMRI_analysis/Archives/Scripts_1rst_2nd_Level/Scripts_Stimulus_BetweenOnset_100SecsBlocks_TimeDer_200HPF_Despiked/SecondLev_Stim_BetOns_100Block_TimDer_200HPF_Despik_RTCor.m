...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Stimulus_BetweenOnset_100Blocks_TimeDer_200HPF_Despiked', filesep, 'RT_Correlation');
...
cd Analysis_Stimulus_BetweenOnset_100Blocks_TimeDer_200HPF_Despiked;
