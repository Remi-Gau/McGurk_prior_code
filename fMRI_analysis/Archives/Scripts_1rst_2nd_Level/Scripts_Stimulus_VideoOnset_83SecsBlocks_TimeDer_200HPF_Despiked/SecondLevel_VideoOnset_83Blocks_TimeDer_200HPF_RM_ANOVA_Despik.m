...
B = repmat([strcat(filesep, 'Analysis_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked', filesep, 'con_00')], length(SubjectsList)*4, 1);
A = [A B]; clear B
...
save (strcat('Second_Level_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked_RM_ANOVA_jobs'), 'matlabbatch');
