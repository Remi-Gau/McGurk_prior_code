...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked', filesep, 'Correlation');
...
mkdir Analysis_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked;
cd Analysis_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked;
mkdir Correlation
...
for j=1:length(ListOfContrastNames)
    ...
    for i=1:length(SubjectsList)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked', filesep);
