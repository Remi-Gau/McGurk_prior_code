...
try
    ...
    for h=1:length(SubjectsList)
        ...
        AnalysisFolder = strcat(SubjectFolder, 'Analysis_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked', filesep);
...
%%
        ...
        for i = 1:NbRuns
            ...
            for j = 1:length(Conditions_Names)
                ...
                matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,i).cond(1,j).duration = Condition_Duration(j);
        ...
        save (strcat('First_Level_Analysis_VideoOnset_83SecsBlocks_TimeDer_200HPF_Despiked_', SubjID, '_jobs'));
