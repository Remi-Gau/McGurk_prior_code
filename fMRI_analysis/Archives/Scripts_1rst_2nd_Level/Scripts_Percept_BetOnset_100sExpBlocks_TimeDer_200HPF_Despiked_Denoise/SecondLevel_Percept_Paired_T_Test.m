...
for h=1:length(SubjectsList)
        ...
        AnalysisFolder = fullfile(SubjectFolder, 'Analysis_Percept_BetOnset_100ExpBlock_TimeDer_200HPF_Despiked_Denoise');
...
%%
cd SecondLevel
mkdir (fullfile(pwd, 'Analysis_Percept_BetOnset_100ExpBlock_TimeDer_200HPF_Despiked_Denoise', 'Paired_T-Test'));
cd ..

GroupAnalysisFolder = fullfile(pwd, 'SecondLevel', 'Analysis_Percept_BetOnset_100ExpBlock_TimeDer_200HPF_Despiked_Denoise', 'Paired_T-Test');
...
for j=1:2 %length(ListOfTest)
    ...
    for i=1:length(SubjectsListTemp)
        ...
        A = fullfile(PresentFolder, num2str(SubjectsListTemp(i)), ...
            'Analysis_Percept_BetOnset_100ExpBlock_TimeDer_200HPF_Despiked_Denoise', ...
            'con_00');
