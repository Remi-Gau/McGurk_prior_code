...
try
    ...
    for h=1:length(SubjectsList)
        ...
        cd(SubjectFolder)
        if exist(strcat('Analysis_ResponseType_TimeDerivative'),'dir')==0
            mkdir Analysis_ResponseType_TimeDerivative
        end;
        ...
        save (strcat('First_Level_Different_Filter_', SubjID, '_jobs'));
