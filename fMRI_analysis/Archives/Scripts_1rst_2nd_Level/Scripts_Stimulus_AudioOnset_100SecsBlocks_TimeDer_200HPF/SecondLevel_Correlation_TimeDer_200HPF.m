...
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_TimeDer_200HPF', filesep, 'Correlation');
...
mkdir Analysis_TimeDer_200HPF;
cd Analysis_TimeDer_200HPF;
mkdir Correlation
...
for j=1:length(ListOfContrastNames)
    ...
    for i=1:length(SubjectsList)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_TimeDer_200HPF', filesep);
