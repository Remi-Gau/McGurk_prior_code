...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Percept_AudioOnset_100SecsBlocks_TimeDer_200HPF_Despiked', filesep, 'Correlation');
