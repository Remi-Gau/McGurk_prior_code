...
try
    ...
    for h=1:length(SubjectsList)
        ...
        for i = 1:NbRuns
            ...
            matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,i).cond(1,Counter).duration = 83;
            matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,i).cond(1,Counter).tmod = 0;
            matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,i).cond(1,Counter).pmod=struct('name',{},'param',{}, 'poly', {});
        ...
        save (strcat('First_Level_Analysis_ResponseType_AudioOnset_83SecsBlocks_TimeDer_200HPF_', SubjID, '_jobs'));
