...
%%
cd SecondLevel
mkdir (fullfile(pwd,'Analysis_Percept_BetweenOnset_83ExpBlocks_TimeDer_200HPF_Despiked', 'Paired_T-Test_2'));
cd ..

GroupAnalysisFolder = fullfile(pwd, 'SecondLevel', 'Analysis_Percept_BetweenOnset_83ExpBlocks_TimeDer_200HPF_Despiked', 'Paired_T-Test_2');
