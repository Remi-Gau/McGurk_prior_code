...
SubjectsList = [1 13 14 15 24 28 32 41 48 66 69 73 74 82 61 98]; % 98 61

cd SecondLevel
if exist('All_Without_Derivatives','dir')==0
    mkdir All_Without_Derivatives;
end;
cd ..

GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'All_Without_Derivatives', filesep);
