...
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'All_Without_Derivatives', filesep, 'Correlation');
...
mkdir All_Without_Derivatives;
cd All_Without_Derivatives;
mkdir Correlation
...
for j=1:length(ListOfContrastNames)
    ...
    for i=1:length(SubjectsList)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_Without_Temporal_Derivative', filesep);
