...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Stimulus_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked', filesep, 'Correlation');

ListOfContrast = {'con_0003.img' ; 'con_0004.img' ; 'con_0005.img'; 'con_0008.img' ; 'con_0008.img'};

ListOfContrastNames = {'McGurkInCON trials' ; 'McGurkInINC trials' ; 'McGurkInCON trials VS McGurkInINC trials' ; 'INC trials VS Visual answers' ; 'INC trials VS Auditory answers' };
