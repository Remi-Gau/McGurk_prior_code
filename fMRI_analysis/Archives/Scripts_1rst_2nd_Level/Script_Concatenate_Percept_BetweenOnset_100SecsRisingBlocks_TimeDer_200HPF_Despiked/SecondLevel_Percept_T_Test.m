...
cd SecondLevel
mkdir(fullfile(pwd,'Analysis_Concatenated_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked','T-Test'));
cd ..

GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'Analysis_Concatenated_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked', filesep, 'T-Test', filesep);
...
for j=1:length(ListOfTest)
    ...
    for i=1:length(SubjectsListTemp)
        ...
        A = strcat(PresentFolder, filesep, num2str(SubjectsListTemp(i)), filesep, ...
            'Analysis_Concatenated_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked', filesep, ...
            'con_00');
