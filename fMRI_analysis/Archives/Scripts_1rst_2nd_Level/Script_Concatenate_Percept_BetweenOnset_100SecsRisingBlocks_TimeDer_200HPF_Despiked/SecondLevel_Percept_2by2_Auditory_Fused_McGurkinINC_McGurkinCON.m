...
B = repmat([strcat(filesep, 'Analysis_Concatenated_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked', filesep, 'con_000')], length(SubjectsList)*4, 1);
A = [A B];
clear B
...
cd Analysis_Concatenated_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked;
