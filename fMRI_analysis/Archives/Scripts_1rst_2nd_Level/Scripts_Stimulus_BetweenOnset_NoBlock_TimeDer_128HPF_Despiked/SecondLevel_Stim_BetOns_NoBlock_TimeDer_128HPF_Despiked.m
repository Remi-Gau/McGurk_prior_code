...
ListOfTest = {'Events_McGurk', 'Events_Non_McGurk'};

ListOfContrast = {'con_0003.img', 'con_0004.img' ; 'con_0007.img', 'con_0008.img'};
...
cd SecondLevel
mkdir Analysis_Stimulus_BetweenOnset_NoBlock_TimeDer_128HPF_Despiked;
cd ..

GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'Analysis_Stimulus_BetweenOnset_NoBlock_TimeDer_128HPF_Despiked', filesep);
...
for j=1:length(ListOfTest)
    ...
    for i=1:length(SubjectsList)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_Stimulus_BetweenOnset_NoBlock_TimeDer_128HPF_Despiked', filesep);
    ...
    save (strcat('Second_Level_Paired_TTest_Analysis_Stimulus_BetweenOnset_NoBlock_TimeDer_128HPF_Despiked', (ListOfTest{j}) , '_jobs'));
