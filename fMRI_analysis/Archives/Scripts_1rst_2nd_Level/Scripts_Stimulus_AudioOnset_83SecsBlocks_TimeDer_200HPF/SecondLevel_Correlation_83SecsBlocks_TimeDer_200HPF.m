...
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_83SecsBlocks_TimeDer_200HPF', filesep, 'Correlation');
...
for j=1:length(ListOfContrastNames)
    ...
    for i=1:length(SubjectsList)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_83SecsBlocks_TimeDer_200HPF', filesep);
