...
for h = 1:length(SubjectsList)
        ...
        AnalysisFolder = strcat(SubjectFolder, 'Analysis_Percept_BetOnset_100ExpBlock_TimeDer_Despiked_Denoise_2', filesep);
...
B = repmat([strcat(filesep, 'Analysis_Percept_BetOnset_100ExpBlock_TimeDer_Despiked_Denoise_2', filesep, 'con_000')], length(SubjectsList)*4, 1);
A = [A B];
clear B
...
%% Defines batch
cd SecondLevel;
mkdir Analysis_Percept_BetOnset_100ExpBlock_TimeDer_Despiked_Denoise_2;
cd Analysis_Percept_BetOnset_100ExpBlock_TimeDer_Despiked_Denoise_2;
...
save (strcat('Second_Level_Analysis_Percept_BetOnset_100ExpBlock_TimeDer_Despiked_Denoise_2_jobs'), 'matlabbatch');
