...
try
    ...
    for h=1:length(SubjectsList)
        ...
        AnalysisFolder = strcat(SubjectFolder, 'Analysis_83SecsBlocks_TimeDer_200HPF_Despiked', filesep);
...
%%
        ...
        save (strcat('First_Level_Analysis_83SecsBlocks_TimeDer_200HPF_Despiked_', SubjID, '_jobs'));
