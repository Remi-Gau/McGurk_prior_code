...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_83SecsBlocks_TimeDer_200HPF_Despiked', filesep, 'Correlation');
...
cd Analysis_83SecsBlocks_TimeDer_200HPF_Despiked;
mkdir Correlation
