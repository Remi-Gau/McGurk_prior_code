...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Percept_BetweenOnset_100SecsBlocks_TimeDer_200HPF_Despiked', filesep, 'RT_Correlation');
