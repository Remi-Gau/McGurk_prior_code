...
B = repmat([strcat(filesep, 'Analysis_VideoOnset_TimeDer_200HPF', filesep, 'con_00')], length(SubjectsList)*4, 1);
A = [A B]; clear B
...
cd Analysis_VideoOnset_TimeDer_200HPF;
mkdir RM-ANOVA;
cd RM-ANOVA;
...
save (strcat('Second_Level_Analysis_VideoOnset_TimeDer_200HPF_RM_ANOVA_jobs'), 'matlabbatch');
