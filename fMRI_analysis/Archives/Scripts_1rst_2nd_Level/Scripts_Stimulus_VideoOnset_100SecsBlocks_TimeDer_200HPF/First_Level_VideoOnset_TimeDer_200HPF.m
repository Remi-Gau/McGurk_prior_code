...
try
    ...
    for h=1:length(SubjectsList)
        ...
        AnalysisFolder = strcat(SubjectFolder, 'Analysis_VideoOnset_TimeDer_200HPF', filesep);
...
%%
        ...
        save (strcat('First_Level_Analysis_VideoOnset_TimeDer_200HPF_', SubjID, '_jobs'));
