...
ListOfTest = {'Blocks', 'Events_Non_McGurk', 'McGurk_Fused', 'McGurk_Auditory', 'McGurk_CON', 'McGurk_INC'};

ContrastOfInterest = [ 12 13 ; 4 10 ; 2 7 ; 1 6 ; 1 2 ; 6 7 ];
...
GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'Analysis_Percept_AudioOnset_100ExpBlocks_TimeDer_200HPF_Despiked', filesep);
...
for j=1:length(ListOfTest)
    ...
    for i=1:length(SubjectsListTemp)
        ...
        A = strcat(PresentFolder, filesep, num2str(SubjectsListTemp(i)), filesep, ...
            'Analysis_Percept_AudioOnset_100ExpBlocks_TimeDer_200HPF_Despiked', filesep, ...
            'con_00');
