...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Percept_AudioOnset_100ExpBlocks_TimeDer_200HPF_Despiked', filesep, 'Correlation');
...
for j=1:length(ListOfContrastNames)
    ...
    for i=1:length(SubjectsListTemp)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_Percept_AudioOnset_100ExpBlocks_TimeDer_200HPF_Despiked', filesep);
