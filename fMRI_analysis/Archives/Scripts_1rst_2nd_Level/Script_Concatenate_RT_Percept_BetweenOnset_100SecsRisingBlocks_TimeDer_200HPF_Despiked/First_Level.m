...
% -------------------------------------------------------------------------
        ...
        cd(SubjectFolder)
        mkdir Analysis_Concatenated_RT_Percept_BetweenOnset_100ExpBlocks_TimeDer_200HPF_Despiked
...
%             stem(1:NbRuns*NbVols,B)
        ...
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).cond(1,1).name = 'Trials';
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).cond(1,1).duration = Condition_Duration;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).cond(1,1).tmod = 0;
        
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).cond(1,1).pmod.name = 'Reaction Times';
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).cond(1,1).pmod.param = ReactionTimes;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).cond(1,1).pmod.poly=1;
        
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).cond(1,1).onset = Pooled_SOT;
        ...
        ReactionTimesParamMod = SPM.xX.X(:,2);
        ...
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).regress(1,Counter).name = 'Reaction time parametric modulator';
        matlabbatch{1,1}.spm.stats.fmri_spec.sess(1,1).regress(1,Counter).val = ReactionTimesParamMod;
        Counter = Counter + 1;
        ...
        % Inputs the session mean regressors
        for j=1:NbRuns-1
