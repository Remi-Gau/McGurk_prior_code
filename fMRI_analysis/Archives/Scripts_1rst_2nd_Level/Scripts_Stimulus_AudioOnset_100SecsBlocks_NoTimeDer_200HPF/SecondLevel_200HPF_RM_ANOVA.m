...
B = repmat([strcat(filesep, 'Analysis_NoTimeDer_200HPF', filesep, 'con_00')], length(SubjectsList)*4, 1);
A = [A B]; clear B
...
save (strcat('Second_Level_Analysis_200HPF_RM_ANOVA_jobs'), 'matlabbatch');
