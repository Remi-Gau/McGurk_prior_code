...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Stimulus_AOnset_100ExpBlock_TimeDer_200HPF_Despiked', filesep, 'Correlation');
...
cd Analysis_Stimulus_AOnset_100ExpBlock_TimeDer_200HPF_Despiked;
mkdir Correlation
