...
ListOfTest = {'Events_McGurk', 'Blocks', 'Events_Non_McGurk', 'McGurk_VS_non_McGurk'};

ListOfContrast = {'con_0003.img', 'con_0004.img' ; 'con_0008.img', 'con_0009.img' ; 'con_0012.img', 'con_0013.img' ; 'con_0002.img', 'con_0014.img'};
...
ListOfContrastNames = {'McGurkInCON trials > McGurkInINC trials', 'McGurkInINC trials > McGurkInCON trials' , 'McGurkInCON trials > Baseline', 'McGurkInINC trials > Baseline' , 'McGurkInCON trials < Baseline', 'McGurkInINC trials < Baseline', 'McGurkInCON + McGurkInINC > Baseline' , 'McGurkInCON + McGurkInINC < Baseline' ; ...
                       ...
                       'McGurk trials > non McGurk trials', 'non McGurk trials > McGurk trials' , 'McGurk trials > Baseline', 'non McGurk trials > Baseline' , 'McGurk trials< Baseline', 'non McGurk trials < Baseline' , 'McGurk trials + non McGurk trials > Baseline' , 'McGurk trials + non McGurk trials < Baseline'};
...
GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'Analysis_Stimulus_AOnset_100ExpBlock_TimeDer_200HPF_Despiked', filesep);
...
for j=1:length(ListOfTest)
    ...
    for i=1:length(SubjectsList)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_Stimulus_AOnset_100ExpBlock_TimeDer_200HPF_Despiked', filesep);
    ...
    save (strcat('Second_Level_Paired_TTest_Analysis_Stimulus_AOnset_100ExpBlock_TimeDer_200HPF_Despiked', (ListOfTest{j}) , '_jobs'));
