...
% Subject's Identity
SubjectsList = 41; %[13 14 15 24 28 32 41 48 61 66 69 73 74 82 98 1];
...
try
    ...
    for h=1:length(SubjectsList)
        ...
        AnalysisFolder = strcat(SubjectFolder, 'Analysis_TimeDer_200HPF_Despiked', filesep);
        ...
        mkdir Analysis_TimeDer_200HPF_Despiked;
...
%%
        ...
        save (strcat('First_Level_Analysis_TimeDer_200HPF_Despiked_', SubjID, '_jobs'));
