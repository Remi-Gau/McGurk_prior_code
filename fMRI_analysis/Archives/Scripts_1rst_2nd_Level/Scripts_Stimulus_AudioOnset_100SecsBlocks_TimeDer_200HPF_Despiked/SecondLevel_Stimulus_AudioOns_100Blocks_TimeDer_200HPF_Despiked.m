...
GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'Analysis_Stimulus_AudioOnset_100SecsBlocks_TimeDer_200HPF_Despiked', filesep);
...
for j=1:length(ListOfTest)
    ...
    save (strcat('Second_Level_Paired_TTest_Analysis_Stimulus_AudioOnset_100SecsBlocks_TimeDer_200HPF_Despiked', (ListOfTest{j}) , '_jobs'));
