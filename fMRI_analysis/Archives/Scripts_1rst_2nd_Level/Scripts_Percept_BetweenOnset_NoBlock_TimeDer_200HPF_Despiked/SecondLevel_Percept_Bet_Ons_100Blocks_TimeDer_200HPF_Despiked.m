...
GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked', filesep);
...
for j=1:length(ListOfTest)
    ...
    for i=1:length(SubjectsListTemp)
        ...
        A = strcat(PresentFolder, filesep, num2str(SubjectsListTemp(i)), filesep, ...
            'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked', filesep, ...
            'con_00');
