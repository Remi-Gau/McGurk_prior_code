...
cd ..
StartFolder = pwd;
GroupAnalysisFolder = strcat(StartFolder, filesep, 'SecondLevel', filesep, 'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked', filesep, 'RT_Correlation');
...
for h = 1:length(SubjectsList)
        ...
        AnalysisFolder = strcat(SubjectFolder, 'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked', filesep);
...
%%
cd SecondLevel
mkdir Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked;
load('GroupRT.mat')

cd Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked;
...
for j=1:length(ListOfContrastNames)
    ...
    for i=1:length(SubjectsListTemp)
        ...
        SubjectAnalysisFolder = strcat(StartFolder, filesep, num2str(SubjID), filesep,'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked', filesep);
