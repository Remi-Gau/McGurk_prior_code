...
B = repmat([strcat(filesep, 'Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked', filesep, 'con_000')], length(SubjectsList)*4, 1);
A = [A B];
clear B
...
save (strcat('Second_Level_Analysis_Percept_BetweenOnset_NoBlock_TimeDer_200HPF_Despiked_RM-ANOVA_jobs'), 'matlabbatch');
