...
B = repmat([strcat(filesep, 'Analysis_ResponseType_100SecsBlocks_TimeDer_200HPF', filesep, 'con_000')], length(SubjectsList)*4, 1);
A = [A B];
clear B
...
cd Analysis_ResponseType_100SecsBlocks_TimeDer_200HPF;
...
save (strcat('Second_Level_Analysis_ResponseType_100SecsBlocks_TimeDer_200HPF_RM_ANOVA_jobs'), 'matlabbatch');
