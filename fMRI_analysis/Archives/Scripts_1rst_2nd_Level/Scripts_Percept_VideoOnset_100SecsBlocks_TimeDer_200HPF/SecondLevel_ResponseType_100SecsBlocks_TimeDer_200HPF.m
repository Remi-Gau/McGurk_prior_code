...
GroupAnalysisFolder = strcat(pwd, filesep, 'SecondLevel', filesep, 'Analysis_ResponseType_100SecsBlocks_TimeDer_200HPF', filesep);
...
for j=1:length(ListOfTest)
    ...
    for i=1:length(SubjectsList)
        ...
        A = strcat(PresentFolder, filesep, num2str(SubjectsList(i)), filesep, ...
            'Analysis_ResponseType_100SecsBlocks_TimeDer_200HPF', filesep, ...
            'con_00');
