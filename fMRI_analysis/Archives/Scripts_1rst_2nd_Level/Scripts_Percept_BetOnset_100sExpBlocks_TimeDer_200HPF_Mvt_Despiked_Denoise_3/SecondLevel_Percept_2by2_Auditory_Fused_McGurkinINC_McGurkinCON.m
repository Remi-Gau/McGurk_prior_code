...
for h = 1:length(SubjectsList)
        ...
        AnalysisFolder = strcat(SubjectFolder, 'Analysis_Percept_BetOnset_100ExpBlock_TimeDer200HPF_Mvt_Despiked_Denoise_3', filesep);
...
B = repmat([strcat(filesep, 'Analysis_Percept_BetOnset_100ExpBlock_TimeDer200HPF_Mvt_Despiked_Denoise_3', filesep, 'con_000')], length(SubjectsList)*4, 1);
A = [A B];
clear B
...
%% Defines batch
cd SecondLevel;
mkdir Analysis_Percept_BetOnset_100ExpBlock_TimeDer200HPF_Mvt_Despiked_Denoise_3;
cd Analysis_Percept_BetOnset_100ExpBlock_TimeDer200HPF_Mvt_Despiked_Denoise_3;
...
save (strcat('Second_Level_Analysis_Percept_BetOnset_100ExpBlock_TimeDer200HPF_Mvt_Despiked_Denoise_3_jobs'), 'matlabbatch');
